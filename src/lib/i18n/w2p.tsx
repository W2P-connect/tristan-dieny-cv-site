  ...
  fr: [
    {
      ...
      content: [
        <p>
          L'idée de W2P est née lors de mon expérience chez une entreprise spécialisée dans le chanvre (
          <CustomLink href={"/projects/llfc"}>voir l'expérience</CustomLink>).
        </p>,
      ...
      content: [
        {
          ...
          type: 'text',
          content: [
            <p>W2P se compose de deux entités indépendantes mais interconnectées :</p>,
            <ul>
              <li>Le plugin installé chez le client, qui prétraite les requêtes à synchroniser avec Pipedrive.</li>
              <li>
                Le site <Link href={'https://woocommerce-to-pipedrive.com/'}>W2P</Link> qui réceptionne, valide, puis transmet les requêtes à Pipedrive. La réponse de l'API Pipedrive est ensuite renvoyée au plugin du client.
              </li>
            </ul>,
          ],
        },
        {
          ...
          content: [
            <>
              ...
              <ul>
                <li>Un backend en PHP, qui capte les événements et données de WooCommerce et WordPress.</li>
                <li>
                  Un frontend en React, permettant de configurer la synchronisation : champs à transmettre, déclencheurs, etc.
                </li>
              </ul>
            </>,
          ],
        },
        {
          ...
          content: [
            <>
              ...
              <ul>
                <li>
                  La partie e-commerce : présentation de l’outil (fonctionnalités, avis, contact, tutoriels), commande d’abonnements via Stripe, espace client avec accès aux factures.
                </li>
                <li>
                  La vérification des abonnements : chaque requête envoyée par un plugin actif est validée via Stripe avant d’être transmise à Pipedrive. Cela garantit que seuls les clients abonnés peuvent utiliser l’API, tout en agissant comme proxy sécurisé.
                </li>
              </ul>
            </>,
          ],
      ...
      content: [
        {
          ...
          type: 'text',
          content: [
            <p>W2P is made up of two independent but interconnected entities:</p>,
            <ul>
              <li>The plugin installed on the client’s site, which pre-processes requests to be synced with Pipedrive.</li>
              <li>
                The <Link href={'https://woocommerce-to-pipedrive.com/'}>W2P website</Link>, which receives, validates, and forwards these requests to Pipedrive. The response from the Pipedrive API is then sent back to the client’s plugin.
              </li>
            </ul>,
          ],
        },
          ...
          content: [
            <>
              ...
              <ul>
                ...
                <li>
                  A React frontend that allows configuration of synchronization settings: fields to send, event triggers, etc.
                </li>
              </ul>
            </>,
          ],
        },
        {
          ...
          content: [
            <>
              ...
              <ul>
                <li>
                  The e-commerce interface: showcasing the tool (features, reviews, contact, tutorials), processing subscription payments via Stripe, and offering a customer dashboard with access to invoices.
                </li>
                <li>
                  Subscription verification: each request sent by an active plugin is validated through Stripe before being forwarded to Pipedrive. This ensures that only subscribed users can access the API, while also acting as a secure proxy.
                </li>
              </ul>
            </>,
          ],
