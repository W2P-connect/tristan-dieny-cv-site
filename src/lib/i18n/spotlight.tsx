...
export const spotlightProjectContent: ProjectContent = {
  fr: [
    ...
    },
    {
      ...
      type: 'text',
      content: [
        <p>Spotlight m’a permis d’approfondir mes compétences sur Next JS, Tailwind CSS et TypeScript. Fort de mon projet avec  <CustomLink newTab href='/projects/w2p'>W2P</CustomLink>, j'ai également réutilisé supabase et prisma pour la gestion des données et des sessions.</p>,
...
en: [
  ...
  },
  {
    ...
    type: 'text',
    content: [
      <p>Spotlight allowed me to deepen my skills in Next JS, Tailwind CSS, and TypeScript. Building on my work with <CustomLink newTab href='/projects/w2p'>W2P</CustomLink>, I also reused Supabase and Prisma to manage data and sessions.</p>,
