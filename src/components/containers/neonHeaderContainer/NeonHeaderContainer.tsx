...
export default async function NeonHeaderContainer({ children }: { children: React.ReactNode }) {
  return (
    <div className={`relative isolate overflow-hidden px-6 lg:px-8 pt-14 `}>
      {/* Neon Lines */}
      <div className="z-0 absolute blur-[1px] inset-0 overflow-hidden pointer-events-none">
        <div className="top- left-0 absolute bg-primary-light shadow-neon-purple rounded-2xl w-2 h-full max-h-[50%] sm:max-h-[80%] rotate-135" />
